...
// answers `disabled` for — the push then carries the body it always had. The registry itself is the
// one built above for the cache probe: one set of adapters, one memoised path cache.
