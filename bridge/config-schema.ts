...
export const CONFIG_SETTINGS: readonly ConfigSetting[] = [
  ...
  {
    key: "dir_roots",
    env: "COLLIE_DIR_ROOTS",
    section: "bridge",
    kind: "roots",
    default: [],
    doc: "FORK: the folders the phone's directory picker may browse. Unset, it browses nothing.",
    configField: "dirRoots",
  },
  {
    key: "doc_hosts",
    env: "COLLIE_DOC_HOSTS",
    section: "bridge",
    kind: "list",
    default: [],
    doc: "FORK: the hostnames whose links open in the built-in document reader.",
  ...
  {
    key: "quota_command",
    env: "COLLIE_QUOTA_COMMAND",
    section: "bridge",
    kind: "string",
    default: "",
    doc: "FORK: the command whose JSON fills the dashboard's usage card. Unset, no card is drawn.",
    configField: "quotaCommand",
  },
  {
    key: "shot_command",
    env: "COLLIE_SHOT_COMMAND",
    section: "bridge",
    kind: "string",
    default: "",
    doc: "FORK: the screenshot command behind annotate-and-ask. Unset, the button is absent.",
    configField: "shotCommand",
  },
  {
    key: "shot_hosts",
    env: "COLLIE_SHOT_HOSTS",
    section: "bridge",
    kind: "list",
    default: [],
    doc: "FORK: the hosts that command may be pointed at. Unset, it may be pointed at none.",
    configField: "shotHosts",
  },
];
