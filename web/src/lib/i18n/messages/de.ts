...
export const de: Dictionary = {
  ...
  "settings.notify.panes.title": "Pro Pane",
  "settings.notify.panes.hint": "Überschreibt die Schalter oben für ein Pane. Eine Regel passt auch auf den Namen des Panes und überlebt so einen Neustart.",
  "settings.notify.panes.mode.default": "Standard",
  "settings.notify.panes.mode.all": "Alle",
  "settings.notify.panes.mode.blocked": "Eingabe nötig",
  "settings.notify.panes.mode.mute": "Stumm",
  "settings.notify.panes.snooze": "1 h schlummern",
  "settings.notify.panes.snoozed": "Stumm bis {time}",
  "settings.notify.panes.resume": "Fortsetzen",
  "settings.notify.panes.gone": "nicht geöffnet",
  "settings.notify.panes.remove": "Regel entfernen",
  "settings.notify.panes.empty": "Gerade keine Panes.",
  "settings.notify.panes.fromFile": "notify.toml: „{label}“",
  "agentCard.approve.yes": "Ja",
  "agentCard.approve.no": "Nein",
  "agentCard.approve.sent": "Gesendet",
  "agentCard.approve.changed": "Dialog geändert",
  "agentCard.approve.failed": "Fehlgeschlagen",
  ...
  "composer.status.recallFailed": "Der Agent ließ sich nicht unterbrechen",
  ...
  "chat.dock.showAria": "Eingabebereich einblenden",
  ...
  "dirs.truncated": "Nur die ersten {count} angezeigt",
  "newTab.title": "Was öffnet das +?",
  "newTab.hint": "Ein Tippen öffnet es sofort und legt fest, was das + tut.",
  "newTab.shell": "Einfache Shell",
  ...
  "quickActions.group.others": "weitere",
  "quickActions.group.harness": "agent",
  "quickActions.confirm": "Nochmal zum Bestätigen",
  ...
  "diff.row.label": "Was sich geändert hat",
  "diff.title": "Änderungen",
  "diff.subtitle": "{branch} · {root}",
  "diff.loading": "Arbeitsbaum wird gelesen…",
  "diff.empty": "Keine Änderungen – der Arbeitsbaum ist sauber.",
  "diff.refresh": "Aktualisieren",
  "diff.back": "Zurück zur Dateiliste",
  "diff.copyPath": "Pfad kopieren",
  "diff.copied": "Kopiert",
  "diff.truncated": "Gekürzt – die Änderung ist größer, als das Telefon zeigt.",
  "diff.binary": "binär",
  "diff.staged": "vorgemerkt",
  "diff.error.notRepo": "Dieses Pane liegt in keinem Git-Arbeitsbaum.",
  "diff.error.outside": "Der Ordner des Panes liegt außerhalb dessen, was Collie lesen darf.",
  "diff.error.failed": "Änderungen konnten nicht gelesen werden.",

  // --- FORK: Dateibetrachter, Vorschau-Panel und die Chips am Spiegel ---
  "diff.openFile": "Datei öffnen",
  "diff.openFileAria": "{path} öffnen",
  "diff.chipFiles": "{count} Dateien",
  "diff.chipAria": "Was sich geändert hat: {files} Dateien, {additions} hinzugefügt, {deletions} entfernt",
  "file.title": "Datei",
  "file.subtitle": "{lines} Zeilen · {bytes} Bytes",
  "file.loading": "Datei wird gelesen…",
  "file.refresh": "Aktualisieren",
  "file.copyPath": "Pfad kopieren",
  "file.copied": "Kopiert",
  "file.preview": "Vorschau",
  "file.more": "{count} weitere Zeilen anzeigen",
  "file.truncated": "Gekürzt — die Datei ist größer, als das Telefon anzeigt.",
  "file.error.binary": "Keine Textdatei.",
  "file.error.outside": "Der Ordner des Panes liegt außerhalb dessen, was Collie lesen darf.",
  "file.error.badPath": "Kein Pfad in diesem Arbeitsverzeichnis.",
  "file.error.notFound": "Datei nicht gefunden — sie wurde vielleicht verschoben oder gelöscht.",
  "file.error.failed": "Datei konnte nicht gelesen werden.",
  "preview.title": "Vorschau",
  "preview.reload": "Neu laden",
  "preview.openExternally": "Im Browser öffnen",
  "preview.width.aria": "Vorschaubreite",
  "preview.width.fit": "Passend",
  "mirror.chip.open": "Öffnen",
  "mirror.chip.openAria": "{url} öffnen",
  "mirror.chip.preview": "Vorschau",
  "mirror.chip.previewAria": "Lokalen Server unter {url} öffnen",
  "mirror.chip.file": "Datei",
  "mirror.chip.fileAria": "{path} öffnen",
  "docs.row.label": "Dokumente",
  "docs.title": "Dokumente",
  "docs.search.placeholder": "Wissensdatenbank durchsuchen",
  "docs.recent": "Zuletzt",
  "docs.results": "Ergebnisse",
  "docs.empty": "Keine Dokumente.",
  "docs.more": "Mehr",
  "docs.error": "Der Dokumentenspeicher ist nicht erreichbar.",
  "docs.back": "Zurück",
  "docs.tags.aria": "Tags",
  "queue.title": "Wartet auf Versand",
  "queue.sendNow": "Jetzt senden",
  "queue.discard": "Verwerfen",
  "queue.queued": "Collie nicht erreichbar – aufbewahrt, wird gesendet, sobald es zurück ist.",
  "queue.held": "Wartet auf dich – das Pane hat sich seit dem Einreihen verändert.",
  "queue.sent": "Eingereihte Nachricht gesendet",
  "connection.bridgeRestarting": "Collie startet neu…",
  "connection.tunnelDown": "Collie ist über den Tunnel nicht erreichbar",
  ...
  "hotkeys.open": "Ausgewähltes Pane öffnen",
  "hotkeys.nth": "n-tes Pane öffnen",
  "hotkeys.overview": "Übersicht",
  "hotkeys.home": "Start",
  "hotkeys.settings": "Einstellungen",
  "hotkeys.palette": "Agent-Befehle (in einem Pane)",
  "hotkeys.composer": "Nachrichtenfeld fokussieren",
  "hotkeys.escape": "Nachrichtenfeld verlassen / schließen",
  "hotkeys.help": "Diese Liste",
  "settings.lowPower.title": "Energiesparen",
  "settings.lowPower.description": "Ein verfolgtes Terminal alle 3 Sekunden statt jede Sekunde lesen. Benachrichtigungen und der Live-Feed bleiben unberührt.",
  "settings.lowPower.saveData": "Aktiv, weil dieses Telefon weniger Daten angefordert hat (Datensparmodus).",
  "settings.readAloud.title": "Antworten vorlesen",
  "settings.readAloud.description": "Solange Freisprechen aktiv ist, liest das Telefon jede neue Antwort vor. Nichts verlässt das Gerät.",
  "settings.readAloud.ariaLabel": "Antworten vorlesen",
  "chat.fullReply.speak": "Diese Antwort vorlesen",
  "chat.fullReply.stopSpeaking": "Vorlesen beenden",
  // --- FORK: the usage section (components/quota-card.tsx) ---
  "quota.title": "Verbrauch",
  "quota.refresh.aria": "Verbrauch neu laden",
  "quota.loading": "Verbrauch wird gelesen…",
  "quota.window.5h": "5 h",
  "quota.window.weekly": "Woche",
  "quota.used": "{percent} %",
  "quota.reset": "Reset in {time}",
  "quota.resetNow": "wird zurückgesetzt",
  "quota.missing": "nicht konfiguriert",
  "quota.error": "nicht verfügbar",
  "quota.models": "Modelle",
  "quota.credits": "Guthaben {credits}",
  "quota.row.aria": "Verbrauch von {agent}",
  "quota.time.days": "{d} T {h} h",
  "quota.time.hours": "{h} h {m} min",
  "quota.time.minutes": "{m} min",
  // --- FORK: anchored notes (lib/notes.ts, components/notes-sheet.tsx) ---
  "notes.title.one": "{count} Notiz",
  "notes.title.other": "{count} Notizen",
  "notes.empty": "Noch nichts notiert. Halte einen Diff-Block, einen Beitrag oder ein Dokument gedrückt.",
  "notes.send.one": "{count} Notiz senden",
  "notes.send.other": "{count} Notizen senden",
  "notes.clearSent": "Gesendete löschen",
  "notes.clearAll": "Alle löschen",
  "notes.sentLabel": "gesendet",
  "notes.markSent": "Als gesendet markieren",
  "notes.save": "Speichern",
  "notes.delete": "Notiz löschen",
  "notes.status.sent": "Notizen gesendet",
  "notes.sheet.add": "Notiz hinzufügen",
  "notes.sheet.edit": "Notiz bearbeiten",
  "notes.excerpt.none": "Das Dokument liegt in einem Sandbox-Frame, markierter Text ist also nicht lesbar — diese Notiz gilt dem ganzen Dokument.",
  "notes.comment.label": "Was soll der Agent tun?",
  "notes.comment.placeholder": "Das sitzt auf dem Handy 4 px zu tief…",
  "notes.intent.label": "Absicht",
  "notes.intent.bug": "Fehler",
  "notes.intent.change": "Änderung",
  "notes.intent.question": "Frage",
  "notes.kind.diff": "Diff",
  "notes.kind.transcript": "Beitrag",
  "notes.kind.doc": "Dokument",
  "notes.kind.element": "Element",
  "notes.kind.artifact": "Artefakt",
  "notes.badge.aria": "Notiz {index}",
  "notes.badge.sentAria": "Notiz {index}, gesendet",
  "notes.add.aria": "Hier eine Notiz hinzufügen",
  "notes.add.short": "Notiz",
  "notes.edit.aria": "Notiz hier bearbeiten",
  "notes.edit.short": "ändern",
  "notes.chip.aria": "{count} Notizen — Liste öffnen",
  "notes.doc.button": "Dokument notieren",
  "notes.composer.label": "Notizen",
  "notes.composer.remove": "Notiz {index} entfernen",
  "notes.composer.ask.one": "{count} Notiz mit dieser Nachricht senden?",
  "notes.composer.ask.other": "{count} Notizen mit dieser Nachricht senden?",
  "notes.composer.include": "Mitsenden",
  "notes.composer.skip": "Jetzt nicht",
  "hotkeys.notes": "Notizen dieses Panes öffnen",
  // --- fork: chat mode (pane transcript, ACP tool kinds, pinned plan, away rollup, status line) ---
  "chat.view.label": "Bereichsansicht",
  ...
  "artifacts.chip.aria": "{count} Artefakte – Liste öffnen",
  "artifacts.sheet.title": "Aus diesem Pane",
  "artifacts.sheet.all": "Alle Artefakte",
  "artifacts.empty.heading": "Noch nichts gebaut",
  "artifacts.empty.body": "Registriert ein Agent eine Datei, landet sie hier – unter dem Pane, das sie gebaut hat.",
  "artifacts.empty.pane": "Dieses Pane hat noch nichts registriert.",
  "artifacts.empty.search": "Keine Treffer.",
  "artifacts.failed": "Die Bibliothek konnte nicht gelesen werden.",
  "artifacts.search.placeholder": "Artefakte durchsuchen",
  "artifacts.pinned": "Angeheftet",
  "artifacts.recent": "Zuletzt",
  "artifacts.card.version": "v{version}",
  "artifacts.card.open": "{title} öffnen",
  "artifacts.kind.html": "Seite",
  "artifacts.kind.markdown": "Markdown",
  "artifacts.kind.image": "Bild",
  "artifacts.kind.text": "Text",
  "artifacts.kind.file": "Datei",
  "artifacts.viewer.back": "Zurück",
  "artifacts.viewer.from": "Aus {pane}",
  "artifacts.viewer.origin": "Aus {origin}",
  "artifacts.viewer.noPane": "Keinem Pane zugeordnet",
  "artifacts.viewer.pin": "Anheften",
  "artifacts.viewer.unpin": "Lösen",
  "artifacts.viewer.refresh": "Neu laden",
  "artifacts.viewer.openTab": "In neuem Tab öffnen",
  "artifacts.viewer.delete": "Löschen",
  "artifacts.viewer.deleteConfirm": "Noch einmal tippen, um diese Version zu löschen. Die Datei verlässt die Bibliothek.",
  "artifacts.viewer.versions": "Versionen",
  "artifacts.viewer.attachment": "Als Anhang abgelegt – in einem neuen Tab öffnen, um zu speichern oder zu teilen.",
  "artifacts.viewer.loading": "Lädt…",
  "artifacts.viewer.missing": "Dieses Artefakt gibt es nicht mehr.",
  "artifacts.viewer.note": "Notiz hinterlassen",
  "artifacts.viewer.inKb": "In der Wissensbasis öffnen",
  "preview.save": "Behalten",
  "preview.saved": "Behalten",
  "preview.saveFailed": "Nicht behalten",
  "chat.transcript.empty": "Für diesen Bereich gibt es noch kein Gespräch.",
  "chat.transcript.showTerminal": "Terminal anzeigen",
  "chat.transcript.liveInTerminal": "Arbeitet noch — die Live-Ausgabe steht im Terminal",
  "chat.away.title": "Während Sie weg waren",
  "chat.away.dismiss": "Ausblenden",
  "chat.away.turns": "{n} Agentenzüge",
  "chat.away.userTurns": "{n} von Ihnen",
  "chat.away.diff": "{files} Dateien +{added} −{removed}",
  "chat.away.question": "Eine Frage wartet seit {age}",
  "chat.away.toolKind.read": "Lesevorgänge",
  "chat.away.toolKind.edit": "Änderungen",
  "chat.away.toolKind.delete": "Löschungen",
  "chat.away.toolKind.move": "Verschiebungen",
  "chat.away.toolKind.search": "Suchen",
  "chat.away.toolKind.execute": "Befehle",
  "chat.away.toolKind.think": "Denkschritte",
  "chat.away.toolKind.fetch": "Abrufe",
  "chat.away.toolKind.other": "sonstige Aufrufe",
  "transcript.todo.title": "Plan",
  "transcript.todo.progress": "{done}/{total} erledigt",
  "transcript.tool.running": "läuft",
  ...
  "handoff.model.label": "Codex-Modell",
  "handoff.effort.label": "Denkaufwand",
  "handoff.model.default": "Launcher-Standard",
  "handoff.model.loading": "Modelle werden geladen…",
  "handoff.model.unavailable": "Modelle nicht verfügbar. Der Launcher-Standard funktioniert weiterhin.",
  "handoff.model.hint": "Modelle dieses Macs; der Denkaufwand richtet sich nach dem gewählten Modell.",
  "annotate.intro": "Eine Website auf deinem Mac aufnehmen",
  "annotate.step.source": "Website-URL eingeben und Bildschirmgröße wählen.",
  "annotate.step.mark": "Aufnehmen, dann zeichnen oder ein Element auswählen.",
  "annotate.step.draft": "Zum Entwurf hinzufügen, Änderung beschreiben und senden.",
  "annotate.photo.hint": "Schon ein Bild auf dem Handy? Mit der Büroklammer im Eingabefeld anhängen und markieren.",
  ...
  "annotate.url.label": "Seitenadresse",
  "annotate.url.placeholder": "http://localhost:5173/",
  "annotate.shoot": "Aufnehmen",
  "annotate.retake": "Neu aufnehmen",
  "annotate.shooting": "Aufnahme läuft — der Browser auf dem Mac lädt die Seite…",
  "annotate.empty": "Gib eine lokale Adresse ein und nimm einen Screenshot auf.",
  "annotate.viewport.label": "Bildschirmgröße",
  "annotate.viewport.phone": "Handy",
  "annotate.viewport.tablet": "Tablet",
  "annotate.viewport.desktop": "Desktop",
  "annotate.tool.pen": "Stift",
  "annotate.tool.highlight": "Textmarker",
  "annotate.tool.arrow": "Pfeil",
  "annotate.tool.rect": "Rahmen",
  "annotate.tool.ellipse": "Kreis",
  "annotate.tool.text": "Text",
  "annotate.tool.inspect": "Untersuchen",
  "annotate.undo": "Rückgängig",
  "annotate.redo": "Wiederholen",
  "annotate.clear": "Löschen",
  "annotate.color.label": "Farbe",
  "annotate.text.label": "Beschriftung",
  "annotate.text.placeholder": "Text eingeben, dann auf das Bild tippen",
  "annotate.draw.hint": "Zeichne mit dem Finger auf der Aufnahme.",
  "annotate.inspect.hint": "Tippe ein Element an, um zu sehen, was es ist.",
  "annotate.inspect.probing": "Die Seite wird gefragt, was das ist…",
  "annotate.card.tag": "Tag",
  "annotate.card.component": "Komponente",
  "annotate.card.source": "Quelle",
  "annotate.card.text": "Text",
  "annotate.note.label": "Notiz",
  "annotate.note.placeholder": "Was stimmt daran nicht?",
  "annotate.attach": "Zum Nachrichtenentwurf",
  "annotate.error.tooLarge": "Auch in der kleinsten Größe überschreitet das Bild das Upload-Limit dieses Collie.",
  "annotate.markup.title": "Darauf zeichnen",
  "annotate.markup.done": "Fertig",
  "composer.attachment.draw": "Erst auf dem Bild zeichnen",
  "composer.attachment.keep": "So lassen",
