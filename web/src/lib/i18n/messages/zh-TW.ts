...
export const zhTW: Dictionary = {
  ...
  "settings.notify.panes.title": "依窗格",
  "settings.notify.panes.hint": "為單一窗格覆蓋上方的開關。規則也會比對窗格名稱，重啟後依然有效。",
  "settings.notify.panes.mode.default": "預設",
  "settings.notify.panes.mode.all": "全部",
  "settings.notify.panes.mode.blocked": "僅需輸入",
  "settings.notify.panes.mode.mute": "靜音",
  "settings.notify.panes.snooze": "暫停 1 小時",
  "settings.notify.panes.snoozed": "靜音至 {time}",
  "settings.notify.panes.resume": "恢復",
  ...
  "agentCard.approve.changed": "對話框已變更",
  "agentCard.approve.failed": "失敗",
  ...
  "composer.status.recallFailed": "中斷 agent 失敗",
  ...
  "dirs.truncated": "只顯示前 {count} 筆",
  "newTab.title": "+ 要開什麼？",
  "newTab.hint": "點一下會立刻開啟，並設為 + 的預設。",
  "newTab.shell": "純 shell",
  ...
  "diff.row.label": "看改了什麼",
  "diff.title": "變更",
  "diff.subtitle": "{branch} · {root}",
  "diff.loading": "讀取工作樹中…",
  "diff.empty": "沒有變更——工作樹是乾淨的。",
  "diff.refresh": "重新整理",
  "diff.back": "回到檔案清單",
  "diff.copyPath": "複製路徑",
  "diff.copied": "已複製",
  "diff.truncated": "已截斷——變更太大，手機上只顯示一部分。",
  "diff.binary": "二進位",
  "diff.staged": "已暫存",
  "diff.error.notRepo": "這個 pane 不在 Git 工作樹裡。",
  "diff.error.outside": "這個 pane 的資料夾在 Collie 可讀範圍之外。",
  "diff.error.failed": "無法讀取變更。",

  // --- FORK: 檔案檢視器、預覽面板，以及 mirror 的行內 chip ---
  "diff.openFile": "開啟檔案",
  "diff.openFileAria": "開啟 {path}",
  "diff.chipFiles": "{count} 個檔案",
  "diff.chipAria": "變更內容：{files} 個檔案，新增 {additions} 行，刪除 {deletions} 行",
  "file.title": "檔案",
  "file.subtitle": "{lines} 行 · {bytes} 位元組",
  "file.loading": "正在讀取檔案…",
  "file.refresh": "重新整理",
  "file.copyPath": "複製路徑",
  "file.copied": "已複製",
  "file.preview": "預覽",
  "file.more": "再顯示 {count} 行",
  "file.truncated": "已截斷——這個檔案超過手機能顯示的大小。",
  "file.error.binary": "這不是文字檔。",
  "file.error.outside": "這個 pane 的資料夾在 Collie 可讀範圍之外。",
  "file.error.badPath": "這不是這個工作目錄裡的路徑。",
  "file.error.notFound": "找不到這個檔案——它可能被移動或刪除了。",
  "file.error.failed": "無法讀取檔案。",
  "preview.title": "預覽",
  "preview.reload": "重新載入",
  "preview.openExternally": "在瀏覽器開啟",
  "preview.width.aria": "預覽寬度",
  "preview.width.fit": "符合寬度",
  "mirror.chip.open": "開啟",
  "mirror.chip.openAria": "開啟 {url}",
  "mirror.chip.preview": "預覽",
  "mirror.chip.previewAria": "開啟 {url} 的本機伺服器",
  "mirror.chip.file": "檔案",
  "mirror.chip.fileAria": "開啟 {path}",
  "docs.row.label": "文件",
  "docs.title": "文件",
  "docs.search.placeholder": "搜尋知識庫",
  "docs.recent": "最近",
  "docs.results": "搜尋結果",
  "docs.empty": "沒有文件。",
  "docs.more": "更多",
  ...
  "queue.sendNow": "立即送出",
  "queue.discard": "捨棄",
  "queue.queued": "連不上 Collie——已保留，恢復後送出。",
  "queue.held": "等你確認——排入後這個 pane 的狀態變了。",
  "queue.sent": "已送出排隊中的訊息",
  "connection.bridgeRestarting": "Collie 正在重啟…",
  "connection.tunnelDown": "無法透過 tunnel 連到 Collie",
  ...
  "hotkeys.open": "開啟選取的 pane",
  "hotkeys.nth": "開啟第 n 個 pane",
  "hotkeys.overview": "總覽",
  "hotkeys.home": "首頁",
  "hotkeys.settings": "系統設定",
  "hotkeys.palette": "Agent 指令（在 pane 內）",
  "hotkeys.composer": "聚焦訊息輸入框",
  "hotkeys.escape": "離開輸入框／關閉",
  "hotkeys.help": "這份清單",
  "settings.lowPower.title": "省電模式",
  "settings.lowPower.description": "跟隨中的終端機每 3 秒讀一次，而不是每秒。通知與即時推送不受影響。",
  "settings.lowPower.saveData": "已啟用：這支手機要求減少資料用量（Data Saver）。",
  "settings.readAloud.title": "朗讀回覆",
  "settings.readAloud.description": "語音直接傳送開啟時，每則新回覆由手機念出來。內容不會離開裝置。",
  "settings.readAloud.ariaLabel": "朗讀回覆",
  "chat.fullReply.speak": "朗讀這則回覆",
  "chat.fullReply.stopSpeaking": "停止朗讀",
  // --- FORK: the usage section (components/quota-card.tsx) ---
  "quota.title": "用量",
  "quota.refresh.aria": "重新讀取用量",
  "quota.loading": "讀取用量中…",
  "quota.window.5h": "5 小時",
  "quota.window.weekly": "每週",
  "quota.used": "{percent}%",
  "quota.reset": "{time}後重置",
  "quota.resetNow": "重置中",
  "quota.missing": "未設定",
  "quota.error": "無法取得",
  "quota.models": "模型",
  "quota.credits": "餘額 {credits}",
  "quota.row.aria": "{agent} 用量",
  "quota.time.days": "{d} 天 {h} 小時",
  "quota.time.hours": "{h} 小時 {m} 分",
  "quota.time.minutes": "{m} 分",
  // --- FORK: anchored notes (lib/notes.ts, components/notes-sheet.tsx) ---
  "notes.title.one": "{count} 則註記",
  "notes.title.other": "{count} 則註記",
  "notes.empty": "還沒有註記。長按 diff 區塊、對話輪次或文件即可新增。",
  "notes.send.one": "送出 {count} 則註記",
  "notes.send.other": "送出 {count} 則註記",
  "notes.clearSent": "清除已送出",
  "notes.clearAll": "全部清除",
  "notes.sentLabel": "已送出",
  "notes.markSent": "標記為已送出",
  "notes.save": "儲存",
  "notes.delete": "刪除註記",
  "notes.status.sent": "註記已送出",
  "notes.sheet.add": "新增註記",
  "notes.sheet.edit": "編輯註記",
  "notes.excerpt.none": "文件在沙箱框架中顯示，無法讀取其中選取的文字——這則註記指向整份文件。",
  "notes.comment.label": "想讓 agent 做什麼？",
  "notes.comment.placeholder": "手機上這裡低了 4px…",
  "notes.intent.label": "類型",
  "notes.intent.bug": "問題",
  "notes.intent.change": "修改",
  "notes.intent.question": "提問",
  "notes.kind.diff": "diff",
  "notes.kind.transcript": "輪次",
  "notes.kind.doc": "文件",
  "notes.kind.element": "元素",
  "notes.kind.artifact": "產出",
  "notes.badge.aria": "註記 {index}",
  "notes.badge.sentAria": "註記 {index}，已送出",
  "notes.add.aria": "在這裡加註記",
  "notes.add.short": "註記",
  "notes.edit.aria": "編輯這裡的註記",
  "notes.edit.short": "編輯",
  "notes.chip.aria": "{count} 則註記 — 開啟清單",
  "notes.doc.button": "為這份文件加註記",
  "notes.composer.label": "註記",
  "notes.composer.remove": "移除註記 {index}",
  "notes.composer.ask.one": "連同這則訊息一起送出 {count} 則註記？",
  "notes.composer.ask.other": "連同這則訊息一起送出 {count} 則註記？",
  "notes.composer.include": "一起送出",
  "notes.composer.skip": "暫時不要",
  "hotkeys.notes": "開啟這個 pane 的註記",
  // --- fork: chat mode (pane transcript, ACP tool kinds, pinned plan, away rollup, status line) ---
  "chat.view.label": "窗格檢視",
  ...
  "artifacts.chip.aria": "{count} 個產出：開啟清單",
  "artifacts.sheet.title": "這個窗格的產出",
  "artifacts.sheet.all": "全部產出",
  "artifacts.empty.heading": "還沒有產出",
  "artifacts.empty.body": "agent 登記它做出來的檔案後，會收在這裡，並掛在產出它的窗格底下。",
  "artifacts.empty.pane": "這個窗格還沒登記任何東西。",
  "artifacts.empty.search": "沒有符合的項目。",
  "artifacts.failed": "讀不到產出庫。",
  "artifacts.search.placeholder": "搜尋產出",
  "artifacts.pinned": "已釘選",
  "artifacts.recent": "最近",
  "artifacts.card.version": "v{version}",
  "artifacts.card.open": "開啟 {title}",
  "artifacts.kind.html": "網頁",
  "artifacts.kind.markdown": "Markdown",
  "artifacts.kind.image": "圖片",
  "artifacts.kind.text": "文字",
  "artifacts.kind.file": "檔案",
  "artifacts.viewer.back": "返回",
  "artifacts.viewer.from": "來自 {pane}",
  "artifacts.viewer.origin": "來自 {origin}",
  "artifacts.viewer.noPane": "未掛在任何窗格下",
  "artifacts.viewer.pin": "釘選",
  "artifacts.viewer.unpin": "取消釘選",
  "artifacts.viewer.refresh": "重新載入",
  "artifacts.viewer.openTab": "在新分頁開啟",
  "artifacts.viewer.delete": "刪除",
  "artifacts.viewer.deleteConfirm": "再點一次就刪除這個版本，檔案會從產出庫移除。",
  "artifacts.viewer.versions": "版本",
  "artifacts.viewer.attachment": "以附件保存，在新分頁開啟即可儲存或分享。",
  "artifacts.viewer.loading": "載入中…",
  "artifacts.viewer.missing": "這個產出已不存在。",
  "artifacts.viewer.note": "留 note",
  "artifacts.viewer.inKb": "在知識庫開啟",
  "preview.save": "收進產出",
  "preview.saved": "已收進",
  "preview.saveFailed": "收不進去",
  "chat.transcript.empty": "這個窗格還沒有對話。",
  "chat.transcript.showTerminal": "顯示終端機",
  "chat.transcript.liveInTerminal": "仍在執行 —— 即時輸出在終端機裡",
  "chat.away.title": "你不在的時候",
  "chat.away.dismiss": "關閉",
  "chat.away.turns": "代理 {n} 輪",
  "chat.away.userTurns": "其中你發了 {n} 則",
  "chat.away.diff": "{files} 個檔案 +{added} −{removed}",
  "chat.away.question": "有個問題已經等了 {age}",
  "chat.away.toolKind.read": "讀取",
  "chat.away.toolKind.edit": "編輯",
  "chat.away.toolKind.delete": "刪除",
  "chat.away.toolKind.move": "搬移",
  "chat.away.toolKind.search": "搜尋",
  "chat.away.toolKind.execute": "指令",
  "chat.away.toolKind.think": "思考",
  "chat.away.toolKind.fetch": "抓取",
  "chat.away.toolKind.other": "其他呼叫",
  "transcript.todo.title": "計畫",
  "transcript.todo.progress": "{done}/{total} 已完成",
  "transcript.tool.running": "執行中",
  ...
  "handoff.effort.label": "推理強度（effort）",
  "handoff.model.default": "沿用啟動器設定",
  "handoff.model.loading": "正在讀取模型…",
  "handoff.model.unavailable": "目前無法取得模型選項，仍可沿用啟動器設定交接。",
  "handoff.model.hint": "選項來自這台電腦的 Codex；推理強度依所選模型提供。",
  "annotate.intro": "擷取 Mac 上正在運行的網站",
  "annotate.step.source": "填入網站網址，再選要查看的螢幕尺寸。",
  "annotate.step.mark": "按「截圖」，在圖片上畫記或點選元素。",
  "annotate.step.draft": "放入訊息草稿，寫下想改的地方，再送出。",
  "annotate.photo.hint": "手機已經有截圖？回訊息欄點迴紋針，就能附上圖片並畫記。",
  ...
  "annotate.title": "標註",
  "annotate.url.label": "頁面網址",
  "annotate.url.placeholder": "http://localhost:5173/",
  "annotate.shoot": "截圖",
  "annotate.retake": "重新截圖",
  "annotate.shooting": "正在截圖 — Mac 上的瀏覽器正在載入頁面…",
  "annotate.empty": "填一個本機網址，然後截圖。",
  "annotate.viewport.label": "螢幕尺寸",
  "annotate.viewport.phone": "手機",
  "annotate.viewport.tablet": "平板",
  "annotate.viewport.desktop": "桌機",
  "annotate.tool.pen": "畫筆",
  "annotate.tool.highlight": "螢光筆",
  "annotate.tool.arrow": "箭頭",
  "annotate.tool.rect": "方框",
  "annotate.tool.ellipse": "圓圈",
  "annotate.tool.text": "文字",
  "annotate.tool.inspect": "檢視元素",
  "annotate.undo": "復原",
  "annotate.redo": "重做",
  "annotate.clear": "清除",
  "annotate.color.label": "顏色",
  "annotate.text.label": "文字",
  "annotate.text.placeholder": "先輸入文字，再點圖片",
  "annotate.draw.hint": "用手指在截圖上畫。",
  "annotate.inspect.hint": "點一個元素，看看它是什麼。",
  "annotate.inspect.probing": "正在問頁面那是什麼…",
  "annotate.card.tag": "標籤",
  "annotate.card.component": "元件",
  "annotate.card.source": "原始檔",
  "annotate.card.text": "文字",
  "annotate.note.label": "備註",
  "annotate.note.placeholder": "它哪裡不對？",
  "annotate.attach": "放入訊息草稿",
  "annotate.error.tooLarge": "即使縮到最小，圖片仍超過這台 collie 的上傳上限。",
  "annotate.markup.title": "在圖片上畫",
  "annotate.markup.done": "完成",
  "composer.attachment.draw": "先在圖片上畫",
  "composer.attachment.keep": "保持原樣",
