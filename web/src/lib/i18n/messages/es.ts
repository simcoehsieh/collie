...
export const es: Dictionary = {
  ...
  "settings.notify.panes.title": "Por panel",
  "settings.notify.panes.hint": "Anula los interruptores de arriba para un panel. Una regla también coincide con el nombre del panel, así que sobrevive a un reinicio.",
  "settings.notify.panes.mode.default": "Predeterminado",
  "settings.notify.panes.mode.all": "Todo",
  "settings.notify.panes.mode.blocked": "Requiere atención",
  "settings.notify.panes.mode.mute": "Silenciar",
  "settings.notify.panes.snooze": "Posponer 1 h",
  "settings.notify.panes.snoozed": "Silenciado hasta {time}",
  "settings.notify.panes.resume": "Reanudar",
  ...
  "agentCard.approve.changed": "El diálogo cambió",
  "agentCard.approve.failed": "Falló",
  ...
  "composer.status.recallFailed": "No se pudo interrumpir al agente",
  ...
  "dirs.truncated": "Mostrando las primeras {count}",
  "newTab.title": "¿Qué abre el +?",
  "newTab.hint": "Al tocar se abre ahora y pasa a ser lo que hace el +.",
  "newTab.shell": "Shell simple",
  ...
  "diff.row.label": "Qué cambió",
  "diff.title": "Cambios",
  "diff.subtitle": "{branch} · {root}",
  "diff.loading": "Leyendo el árbol de trabajo…",
  "diff.empty": "Sin cambios: el árbol de trabajo está limpio.",
  "diff.refresh": "Actualizar",
  "diff.back": "Volver a la lista de archivos",
  "diff.copyPath": "Copiar ruta",
  "diff.copied": "Copiado",
  "diff.truncated": "Recortado: el cambio es mayor de lo que el teléfono muestra.",
  "diff.binary": "binario",
  "diff.staged": "preparado",
  "diff.error.notRepo": "Este panel no está en un árbol de trabajo de Git.",
  "diff.error.outside": "La carpeta del panel está fuera de lo que Collie puede leer.",
  "diff.error.failed": "No se pudieron leer los cambios.",

  // --- FORK: el visor de archivos, el panel de vista previa y los chips del espejo ---
  "diff.openFile": "Abrir archivo",
  "diff.openFileAria": "Abrir {path}",
  "diff.chipFiles": "{count} archivos",
  "diff.chipAria": "Qué cambió: {files} archivos, {additions} añadidas, {deletions} eliminadas",
  "file.title": "Archivo",
  "file.subtitle": "{lines} líneas · {bytes} bytes",
  "file.loading": "Leyendo el archivo…",
  "file.refresh": "Actualizar",
  "file.copyPath": "Copiar ruta",
  "file.copied": "Copiado",
  "file.preview": "Vista previa",
  "file.more": "Mostrar {count} líneas más",
  "file.truncated": "Recortado: el archivo es mayor de lo que el teléfono mostrará.",
  "file.error.binary": "No es un archivo de texto.",
  "file.error.outside": "La carpeta del panel está fuera de lo que Collie puede leer.",
  "file.error.badPath": "No es una ruta de este árbol de trabajo.",
  "file.error.notFound": "No existe ese archivo: puede que se haya movido o eliminado.",
  "file.error.failed": "No se pudo leer el archivo.",
  "preview.title": "Vista previa",
  "preview.reload": "Recargar",
  "preview.openExternally": "Abrir en el navegador",
  "preview.width.aria": "Ancho de la vista previa",
  "preview.width.fit": "Ajustar",
  "mirror.chip.open": "Abrir",
  "mirror.chip.openAria": "Abrir {url}",
  "mirror.chip.preview": "Vista previa",
  "mirror.chip.previewAria": "Abrir el servidor local en {url}",
  "mirror.chip.file": "Archivo",
  "mirror.chip.fileAria": "Abrir {path}",
  "docs.row.label": "Documentos",
  "docs.title": "Documentos",
  "docs.search.placeholder": "Buscar en la base de conocimiento",
  "docs.recent": "Recientes",
  "docs.results": "Resultados",
  "docs.empty": "No hay documentos.",
  "docs.more": "Más",
  "docs.error": "No se pudo acceder al almacén de documentos.",
  "docs.back": "Atrás",
  "docs.tags.aria": "Etiquetas",
  "queue.title": "Pendiente de envío",
  "queue.sendNow": "Enviar ahora",
  "queue.discard": "Descartar",
  "queue.queued": "No se pudo contactar con Collie: se guardó para enviarlo cuando vuelva.",
  "queue.held": "Esperándote: el panel cambió desde que se puso en cola.",
  "queue.sent": "Mensaje en cola enviado",
  "connection.bridgeRestarting": "Collie se está reiniciando…",
  "connection.tunnelDown": "No se puede llegar a Collie a través del túnel",
  ...
  "hotkeys.open": "Abrir el panel seleccionado",
  "hotkeys.nth": "Abrir el panel n",
  "hotkeys.overview": "Vista general",
  "hotkeys.home": "Inicio",
  "hotkeys.settings": "Ajustes",
  "hotkeys.palette": "Comandos del agente (en un panel)",
  "hotkeys.composer": "Enfocar el cuadro de mensaje",
  "hotkeys.escape": "Salir del cuadro de mensaje / cerrar",
  "hotkeys.help": "Esta lista",
  "settings.lowPower.title": "Bajo consumo",
  "settings.lowPower.description": "Leer un terminal seguido cada 3 segundos en vez de cada segundo. Las notificaciones y el feed en vivo no cambian.",
  "settings.lowPower.saveData": "Activado porque este teléfono pidió menos datos (ahorro de datos).",
  "settings.readAloud.title": "Leer respuestas en voz alta",
  "settings.readAloud.description": "Mientras manos libres esté activo, el teléfono lee cada respuesta nueva. Nada sale del dispositivo.",
  "settings.readAloud.ariaLabel": "Leer respuestas en voz alta",
  "chat.fullReply.speak": "Leer esta respuesta en voz alta",
  "chat.fullReply.stopSpeaking": "Dejar de leer",
  // --- FORK: the usage section (components/quota-card.tsx) ---
  "quota.title": "Uso",
  "quota.refresh.aria": "Actualizar uso",
  "quota.loading": "Leyendo el uso…",
  "quota.window.5h": "5 h",
  "quota.window.weekly": "Semana",
  "quota.used": "{percent} %",
  "quota.reset": "se reinicia en {time}",
  "quota.resetNow": "reiniciando",
  "quota.missing": "sin configurar",
  "quota.error": "no disponible",
  "quota.models": "Modelos",
  "quota.credits": "Saldo {credits}",
  "quota.row.aria": "Uso de {agent}",
  "quota.time.days": "{d} d {h} h",
  "quota.time.hours": "{h} h {m} min",
  "quota.time.minutes": "{m} min",
  // --- FORK: anchored notes (lib/notes.ts, components/notes-sheet.tsx) ---
  "notes.title.one": "{count} nota",
  "notes.title.other": "{count} notas",
  "notes.empty": "Aún no hay notas. Mantén pulsado un bloque del diff, un turno o un documento.",
  "notes.send.one": "Enviar {count} nota",
  "notes.send.other": "Enviar {count} notas",
  "notes.clearSent": "Borrar enviadas",
  "notes.clearAll": "Borrar todas",
  "notes.sentLabel": "enviada",
  "notes.markSent": "Marcar enviada",
  "notes.save": "Guardar",
  "notes.delete": "Eliminar nota",
  "notes.status.sent": "Notas enviadas",
  "notes.sheet.add": "Añadir una nota",
  "notes.sheet.edit": "Editar la nota",
  "notes.excerpt.none": "El documento va en un marco aislado, así que no se puede leer el texto seleccionado: esta nota apunta al documento entero.",
  "notes.comment.label": "¿Qué debe hacer el agente?",
  "notes.comment.placeholder": "Esto queda 4 px más abajo en el móvil…",
  "notes.intent.label": "Intención",
  "notes.intent.bug": "Error",
  "notes.intent.change": "Cambio",
  "notes.intent.question": "Pregunta",
  "notes.kind.diff": "diff",
  "notes.kind.transcript": "turno",
  "notes.kind.doc": "documento",
  "notes.kind.element": "elemento",
  "notes.kind.artifact": "Artefacto",
  "notes.badge.aria": "Nota {index}",
  "notes.badge.sentAria": "Nota {index}, enviada",
  "notes.add.aria": "Añadir una nota aquí",
  "notes.add.short": "nota",
  "notes.edit.aria": "Editar la nota de aquí",
  "notes.edit.short": "editar",
  "notes.chip.aria": "{count} notas: abrir la lista",
  "notes.doc.button": "Anotar este documento",
  "notes.composer.label": "Notas",
  "notes.composer.remove": "Quitar la nota {index}",
  "notes.composer.ask.one": "¿Enviar {count} nota con este mensaje?",
  "notes.composer.ask.other": "¿Enviar {count} notas con este mensaje?",
  "notes.composer.include": "Incluir",
  "notes.composer.skip": "Ahora no",
  "hotkeys.notes": "Abrir las notas de este panel",
  // --- fork: chat mode (pane transcript, ACP tool kinds, pinned plan, away rollup, status line) ---
  "chat.view.label": "Vista del panel",
  "chat.view.transcript": "Transcripción",
  "chat.view.terminal": "Terminal",
  // FORK: the artifacts library (bridge/artifacts.ts).
  "artifacts.filter.kind": "Tipo de archivo",
  "artifacts.filter.all": "Todos",
  "artifacts.filter.pinned": "Solo fijados",
  "artifacts.results": "{shown} de {total}",
  "artifacts.stale": "Se muestra la última lista. Vuelve a cargar para reintentar.",
  "artifacts.showMore": "Mostrar más",
  "artifacts.title": "Artefactos",
  "artifacts.nav.aria": "Artefactos: lo que hicieron los agentes",
  "artifacts.row.label": "Artefactos",
  "artifacts.chip.aria": "{count} artefactos: abrir la lista",
  "artifacts.sheet.title": "De este panel",
  "artifacts.sheet.all": "Todos los artefactos",
  "artifacts.empty.heading": "Aún no hay nada",
  "artifacts.empty.body": "Cuando un agente registra un archivo que hizo, aparece aquí, bajo el panel que lo hizo.",
  "artifacts.empty.pane": "Este panel aún no ha registrado nada.",
  "artifacts.empty.search": "Nada coincide.",
  "artifacts.failed": "No se pudo leer la biblioteca.",
  "artifacts.search.placeholder": "Buscar artefactos",
  "artifacts.pinned": "Fijados",
  "artifacts.recent": "Recientes",
  "artifacts.card.version": "v{version}",
  "artifacts.card.open": "Abrir {title}",
  "artifacts.kind.html": "página",
  "artifacts.kind.markdown": "markdown",
  "artifacts.kind.image": "imagen",
  "artifacts.kind.text": "texto",
  "artifacts.kind.file": "archivo",
  "artifacts.viewer.back": "Atrás",
  "artifacts.viewer.from": "De {pane}",
  "artifacts.viewer.origin": "De {origin}",
  "artifacts.viewer.noPane": "Sin panel asignado",
  "artifacts.viewer.pin": "Fijar",
  "artifacts.viewer.unpin": "Desfijar",
  "artifacts.viewer.refresh": "Recargar",
  "artifacts.viewer.openTab": "Abrir en una pestaña nueva",
  "artifacts.viewer.delete": "Eliminar",
  "artifacts.viewer.deleteConfirm": "Toca otra vez para eliminar esta versión. El archivo sale de la biblioteca.",
  "artifacts.viewer.versions": "Versiones",
  "artifacts.viewer.attachment": "Guardado como adjunto: ábrelo en una pestaña nueva para guardarlo o compartirlo.",
  "artifacts.viewer.loading": "Cargando…",
  "artifacts.viewer.missing": "Este artefacto ya no existe.",
  "artifacts.viewer.note": "Dejar una nota",
  "artifacts.viewer.inKb": "Abrir en la base de conocimiento",
  "preview.save": "Guardar",
  "preview.saved": "Guardado",
  "preview.saveFailed": "No se pudo guardar",
  "chat.transcript.empty": "Todavía no hay conversación en este panel.",
  "chat.transcript.showTerminal": "Mostrar el terminal",
  "chat.transcript.liveInTerminal": "Sigue trabajando: la salida en vivo está en Terminal",
  "chat.away.title": "Mientras no estabas",
  "chat.away.dismiss": "Descartar",
  "chat.away.turns": "{n} turnos del agente",
  "chat.away.userTurns": "{n} tuyos",
  "chat.away.diff": "{files} archivos +{added} −{removed}",
  "chat.away.question": "Hay una pregunta esperando desde hace {age}",
  "chat.away.toolKind.read": "lecturas",
  "chat.away.toolKind.edit": "ediciones",
  "chat.away.toolKind.delete": "eliminaciones",
  "chat.away.toolKind.move": "movimientos",
  "chat.away.toolKind.search": "búsquedas",
  "chat.away.toolKind.execute": "comandos",
  "chat.away.toolKind.think": "pasos de razonamiento",
  "chat.away.toolKind.fetch": "descargas",
  "chat.away.toolKind.other": "otras llamadas",
  "transcript.todo.title": "Plan",
  "transcript.todo.progress": "{done}/{total} hechas",
  "transcript.tool.running": "en curso",
  ...
  "handoff.model.label": "Modelo de Codex",
  "handoff.effort.label": "Esfuerzo de razonamiento",
  "handoff.model.default": "Predeterminado del lanzador",
  "handoff.model.loading": "Cargando modelos…",
  "handoff.model.unavailable": "No hay modelos disponibles. Puedes usar el valor predeterminado.",
  "handoff.model.hint": "Modelos de Codex de este Mac; el esfuerzo depende del modelo elegido.",
  "annotate.intro": "Captura una web que se ejecuta en tu Mac",
  "annotate.step.source": "Introduce la URL y elige el tamaño de pantalla.",
  "annotate.step.mark": "Captura la página y dibuja o selecciona un elemento.",
  "annotate.step.draft": "Añade la imagen al borrador, describe el cambio y envía.",
  "annotate.photo.hint": "¿Ya tienes una captura en el teléfono? Adjúntala y márcala con el clip del mensaje.",
  ...
  "annotate.url.label": "Dirección de la página",
  "annotate.url.placeholder": "http://localhost:5173/",
  "annotate.shoot": "Capturar",
  "annotate.retake": "Volver a capturar",
  "annotate.shooting": "Capturando — el navegador del Mac está cargando la página…",
  "annotate.empty": "Escribe una dirección local y haz una captura.",
  "annotate.viewport.label": "Tamaño de pantalla",
  "annotate.viewport.phone": "Móvil",
  "annotate.viewport.tablet": "Tableta",
  "annotate.viewport.desktop": "Escritorio",
  "annotate.tool.pen": "Lápiz",
  "annotate.tool.highlight": "Marcador",
  "annotate.tool.arrow": "Flecha",
  "annotate.tool.rect": "Recuadro",
  "annotate.tool.ellipse": "Círculo",
  "annotate.tool.text": "Texto",
  "annotate.tool.inspect": "Inspeccionar",
  "annotate.undo": "Deshacer",
  "annotate.redo": "Rehacer",
  "annotate.clear": "Borrar",
  "annotate.color.label": "Color",
  "annotate.text.label": "Leyenda",
  "annotate.text.placeholder": "Escribe un texto y toca la imagen",
  "annotate.draw.hint": "Dibuja sobre la captura con el dedo.",
  "annotate.inspect.hint": "Toca un elemento para ver qué es.",
  "annotate.inspect.probing": "Preguntando a la página qué es eso…",
  "annotate.card.tag": "Etiqueta",
  "annotate.card.component": "Componente",
  "annotate.card.source": "Origen",
  "annotate.card.text": "Texto",
  "annotate.note.label": "Nota",
  "annotate.note.placeholder": "¿Qué tiene de malo?",
  "annotate.attach": "Añadir al borrador",
  "annotate.error.tooLarge": "Ni en el tamaño más pequeño la imagen cabe en el límite de subida de este collie.",
  "annotate.markup.title": "Dibujar encima",
  "annotate.markup.done": "Listo",
  "composer.attachment.draw": "Dibujar sobre la imagen primero",
  "composer.attachment.keep": "Dejarlo como está",
