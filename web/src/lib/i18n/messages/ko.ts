...
export const ko: Dictionary = {
  ...
  "settings.notify.panes.title": "창별 설정",
  "settings.notify.panes.hint": "위 스위치를 창 단위로 덮어씁니다. 규칙은 창 이름에도 일치하므로 재시작 후에도 유지됩니다.",
  "settings.notify.panes.mode.default": "기본",
  "settings.notify.panes.mode.all": "모두",
  "settings.notify.panes.mode.blocked": "입력 대기만",
  "settings.notify.panes.mode.mute": "음소거",
  "settings.notify.panes.snooze": "1시간 미루기",
  "settings.notify.panes.snoozed": "{time}까지 음소거",
  "settings.notify.panes.resume": "재개",
  ...
  "agentCard.approve.changed": "대화상자가 바뀜",
  "agentCard.approve.failed": "실패",
  ...
  "composer.status.recallFailed": "에이전트를 중단하지 못했습니다",
  ...
  "dirs.truncated": "처음 {count}개만 표시",
  "newTab.title": "+ 로 무엇을 열까요?",
  "newTab.hint": "누르면 바로 열리고 + 의 기본값이 됩니다.",
  "newTab.shell": "일반 셸",
  ...
  "quickActions.group.others": "기타",
  "quickActions.group.harness": "agent",
  "quickActions.confirm": "한 번 더 눌러 확인",
  ...
  "diff.row.label": "무엇이 바뀌었나",
  "diff.title": "변경 사항",
  "diff.subtitle": "{branch} · {root}",
  "diff.loading": "작업 트리 읽는 중…",
  "diff.empty": "변경 없음 — 작업 트리가 깨끗합니다.",
  "diff.refresh": "새로 고침",
  "diff.back": "파일 목록으로",
  "diff.copyPath": "경로 복사",
  "diff.copied": "복사됨",
  "diff.truncated": "잘림 — 변경이 너무 커서 일부만 표시합니다.",
  "diff.binary": "바이너리",
  "diff.staged": "스테이징됨",
  "diff.error.notRepo": "이 창은 Git 작업 트리 안에 있지 않습니다.",
  "diff.error.outside": "이 창의 폴더는 Collie가 읽을 수 있는 범위 밖입니다.",
  "diff.error.failed": "변경 사항을 읽을 수 없습니다.",

  // --- FORK: 파일 뷰어, 미리 보기 패널, 미러의 줄 칩 ---
  "diff.openFile": "파일 열기",
  "diff.openFileAria": "{path} 열기",
  "diff.chipFiles": "파일 {count}개",
  "diff.chipAria": "변경 내용: 파일 {files}개, {additions}줄 추가, {deletions}줄 삭제",
  "file.title": "파일",
  "file.subtitle": "{lines}줄 · {bytes}바이트",
  "file.loading": "파일을 읽는 중…",
  "file.refresh": "새로 고침",
  "file.copyPath": "경로 복사",
  "file.copied": "복사됨",
  "file.preview": "미리 보기",
  "file.more": "{count}줄 더 보기",
  "file.truncated": "잘렸습니다 — 파일이 휴대폰에 표시할 수 있는 크기보다 큽니다.",
  "file.error.binary": "텍스트 파일이 아닙니다.",
  "file.error.outside": "이 창의 폴더는 Collie가 읽을 수 있는 범위 밖입니다.",
  "file.error.badPath": "이 작업 트리 안의 경로가 아닙니다.",
  "file.error.notFound": "그런 파일이 없습니다 — 옮겨졌거나 삭제되었을 수 있습니다.",
  "file.error.failed": "파일을 읽을 수 없습니다.",
  "preview.title": "미리 보기",
  "preview.reload": "다시 불러오기",
  "preview.openExternally": "브라우저에서 열기",
  "preview.width.aria": "미리 보기 너비",
  "preview.width.fit": "맞춤",
  "mirror.chip.open": "열기",
  "mirror.chip.openAria": "{url} 열기",
  "mirror.chip.preview": "미리 보기",
  "mirror.chip.previewAria": "{url}의 로컬 서버 열기",
  "mirror.chip.file": "파일",
  "mirror.chip.fileAria": "{path} 열기",
  "docs.row.label": "문서",
  "docs.title": "문서",
  "docs.search.placeholder": "지식 베이스 검색",
  "docs.recent": "최근",
  "docs.results": "검색 결과",
  "docs.empty": "문서가 없습니다.",
  "docs.more": "더 보기",
  "docs.error": "문서 저장소에 연결할 수 없습니다.",
  "docs.back": "뒤로",
  "docs.tags.aria": "태그",
  "queue.title": "전송 대기 중",
  "queue.sendNow": "지금 보내기",
  "queue.discard": "버리기",
  "queue.queued": "Collie에 연결할 수 없음 — 복구되면 보내도록 보관했습니다.",
  "queue.held": "확인 대기 중 — 대기열에 넣은 뒤 창의 상태가 바뀌었습니다.",
  "queue.sent": "대기 중이던 메시지를 보냈습니다",
  "connection.bridgeRestarting": "Collie 재시작 중…",
  "connection.tunnelDown": "터널을 통해 Collie에 연결할 수 없습니다",
  ...
  "hotkeys.open": "선택한 패널 열기",
  "hotkeys.nth": "n번째 패널 열기",
  "hotkeys.overview": "한눈에 보기",
  "hotkeys.home": "홈",
  "hotkeys.settings": "설정",
  "hotkeys.palette": "에이전트 명령 (패널 안에서)",
  "hotkeys.composer": "메시지 입력창으로 이동",
  "hotkeys.escape": "입력창 벗어나기 / 닫기",
  "hotkeys.help": "이 목록",
  "settings.lowPower.title": "저전력 모드",
  "settings.lowPower.description": "따라가는 터미널을 매초가 아닌 3초마다 읽습니다. 알림과 실시간 피드는 영향받지 않습니다.",
  "settings.lowPower.saveData": "이 휴대폰이 데이터 절약을 요청해 켜져 있습니다.",
  "settings.readAloud.title": "답변 읽어주기",
  "settings.readAloud.description": "핸즈프리가 켜져 있는 동안 새 답변을 휴대폰이 읽어줍니다. 내용은 기기를 벗어나지 않습니다.",
  "settings.readAloud.ariaLabel": "답변 읽어주기",
  "chat.fullReply.speak": "이 답변 읽어주기",
  "chat.fullReply.stopSpeaking": "읽기 중지",
  // --- FORK: the usage section (components/quota-card.tsx) ---
  "quota.title": "사용량",
  "quota.refresh.aria": "사용량 새로고침",
  "quota.loading": "사용량 읽는 중…",
  "quota.window.5h": "5시간",
  "quota.window.weekly": "주간",
  "quota.used": "{percent}%",
  "quota.reset": "{time} 후 초기화",
  "quota.resetNow": "초기화 중",
  "quota.missing": "설정되지 않음",
  "quota.error": "사용 불가",
  "quota.models": "모델",
  "quota.credits": "잔액 {credits}",
  "quota.row.aria": "{agent} 사용량",
  "quota.time.days": "{d}일 {h}시간",
  "quota.time.hours": "{h}시간 {m}분",
  "quota.time.minutes": "{m}분",
  // --- FORK: anchored notes (lib/notes.ts, components/notes-sheet.tsx) ---
  "notes.title.one": "메모 {count}개",
  "notes.title.other": "메모 {count}개",
  "notes.empty": "아직 메모가 없습니다. 차이 블록, 대화 턴, 문서를 길게 눌러 추가하세요.",
  "notes.send.one": "메모 {count}개 보내기",
  "notes.send.other": "메모 {count}개 보내기",
  "notes.clearSent": "보낸 메모 지우기",
  "notes.clearAll": "모두 지우기",
  "notes.sentLabel": "보냄",
  "notes.markSent": "보낸 것으로 표시",
  "notes.save": "저장",
  "notes.delete": "메모 삭제",
  "notes.status.sent": "메모를 보냈습니다",
  "notes.sheet.add": "메모 추가",
  "notes.sheet.edit": "메모 수정",
  "notes.excerpt.none": "문서는 샌드박스 프레임 안에 있어 선택한 텍스트를 읽을 수 없습니다. 이 메모는 문서 전체를 가리킵니다.",
  "notes.comment.label": "에이전트가 무엇을 하면 될까요?",
  "notes.comment.placeholder": "휴대폰에서 4px 아래로 내려가 있어요…",
  "notes.intent.label": "의도",
  "notes.intent.bug": "버그",
  "notes.intent.change": "변경",
  "notes.intent.question": "질문",
  "notes.kind.diff": "차이",
  "notes.kind.transcript": "턴",
  "notes.kind.doc": "문서",
  "notes.kind.element": "요소",
  "notes.kind.artifact": "산출물",
  "notes.badge.aria": "메모 {index}",
  "notes.badge.sentAria": "메모 {index}, 보냄",
  "notes.add.aria": "여기에 메모 추가",
  "notes.add.short": "메모",
  "notes.edit.aria": "여기 메모 수정",
  "notes.edit.short": "수정",
  "notes.chip.aria": "메모 {count}개 — 목록 열기",
  "notes.doc.button": "이 문서에 메모",
  "notes.composer.label": "메모",
  "notes.composer.remove": "메모 {index} 빼기",
  "notes.composer.ask.one": "이 메시지와 함께 메모 {count}개를 보낼까요?",
  "notes.composer.ask.other": "이 메시지와 함께 메모 {count}개를 보낼까요?",
  "notes.composer.include": "같이 보내기",
  "notes.composer.skip": "나중에",
  "hotkeys.notes": "이 pane의 메모 열기",
  // --- fork: chat mode (pane transcript, ACP tool kinds, pinned plan, away rollup, status line) ---
  "chat.view.label": "창 보기",
  ...
  "artifacts.chip.aria": "산출물 {count}개: 목록 열기",
  "artifacts.sheet.title": "이 창의 산출물",
  "artifacts.sheet.all": "모든 산출물",
  "artifacts.empty.heading": "아직 산출물이 없습니다",
  "artifacts.empty.body": "에이전트가 만든 파일을 등록하면 그것을 만든 창 아래에 여기 쌓입니다.",
  "artifacts.empty.pane": "이 창은 아직 아무것도 등록하지 않았습니다.",
  "artifacts.empty.search": "일치하는 항목이 없습니다.",
  "artifacts.failed": "라이브러리를 읽을 수 없습니다.",
  "artifacts.search.placeholder": "산출물 검색",
  "artifacts.pinned": "고정됨",
  "artifacts.recent": "최근",
  "artifacts.card.version": "v{version}",
  "artifacts.card.open": "{title} 열기",
  "artifacts.kind.html": "페이지",
  "artifacts.kind.markdown": "Markdown",
  "artifacts.kind.image": "이미지",
  "artifacts.kind.text": "텍스트",
  "artifacts.kind.file": "파일",
  "artifacts.viewer.back": "뒤로",
  "artifacts.viewer.from": "{pane}에서",
  "artifacts.viewer.origin": "{origin}에서",
  "artifacts.viewer.noPane": "어느 창에도 속하지 않음",
  "artifacts.viewer.pin": "고정",
  "artifacts.viewer.unpin": "고정 해제",
  "artifacts.viewer.refresh": "다시 불러오기",
  "artifacts.viewer.openTab": "새 탭에서 열기",
  "artifacts.viewer.delete": "삭제",
  "artifacts.viewer.deleteConfirm": "한 번 더 누르면 이 버전을 삭제합니다. 파일은 라이브러리에서 제거됩니다.",
  "artifacts.viewer.versions": "버전",
  "artifacts.viewer.attachment": "첨부 파일로 보관됩니다. 새 탭에서 열어 저장하거나 공유하세요.",
  "artifacts.viewer.loading": "불러오는 중…",
  "artifacts.viewer.missing": "이 산출물은 더 이상 없습니다.",
  "artifacts.viewer.note": "메모 남기기",
  "artifacts.viewer.inKb": "지식 베이스에서 열기",
  "preview.save": "보관",
  "preview.saved": "보관됨",
  "preview.saveFailed": "보관 실패",
  "chat.transcript.empty": "이 창에는 아직 대화가 없습니다.",
  "chat.transcript.showTerminal": "터미널 보기",
  "chat.transcript.liveInTerminal": "작업 중 — 실시간 출력은 터미널에 있습니다",
  "chat.away.title": "자리를 비운 사이",
  "chat.away.dismiss": "닫기",
  "chat.away.turns": "에이전트 {n}턴",
  "chat.away.userTurns": "그중 내가 {n}개",
  "chat.away.diff": "{files}개 파일 +{added} −{removed}",
  "chat.away.question": "{age} 전부터 질문이 기다리고 있습니다",
  "chat.away.toolKind.read": "읽기",
  "chat.away.toolKind.edit": "편집",
  "chat.away.toolKind.delete": "삭제",
  "chat.away.toolKind.move": "이동",
  "chat.away.toolKind.search": "검색",
  "chat.away.toolKind.execute": "명령",
  "chat.away.toolKind.think": "사고 단계",
  "chat.away.toolKind.fetch": "가져오기",
  "chat.away.toolKind.other": "기타 호출",
  "transcript.todo.title": "계획",
  "transcript.todo.progress": "{done}/{total} 완료",
  ...
  "handoff.model.label": "Codex 모델",
  "handoff.effort.label": "추론 강도",
  "handoff.model.default": "실행기 기본값",
  "handoff.model.loading": "모델 불러오는 중…",
  "handoff.model.unavailable": "모델 목록을 읽을 수 없습니다. 기본값으로 계속할 수 있습니다.",
  "handoff.model.hint": "이 Mac의 Codex 모델과 해당 모델의 추론 강도를 사용합니다.",
  "annotate.intro": "Mac에서 실행 중인 웹사이트 캡처",
  "annotate.step.source": "웹사이트 주소와 화면 크기를 선택하세요.",
  "annotate.step.mark": "캡처한 이미지에 그리거나 요소를 선택하세요.",
  "annotate.step.draft": "초안에 추가하고 변경 사항을 적은 뒤 보내세요.",
  "annotate.photo.hint": "휴대폰에 스크린샷이 있나요? 메시지의 클립 버튼으로 첨부하고 표시하세요.",
  ...
  "annotate.title": "표시하기",
  "annotate.url.label": "페이지 주소",
  "annotate.url.placeholder": "http://localhost:5173/",
  "annotate.shoot": "촬영",
  "annotate.retake": "다시 촬영",
  "annotate.shooting": "촬영 중 — Mac의 브라우저가 페이지를 여는 중입니다…",
  "annotate.empty": "로컬 주소를 넣고 촬영하세요.",
  "annotate.viewport.label": "화면 크기",
  "annotate.viewport.phone": "휴대폰",
  "annotate.viewport.tablet": "태블릿",
  "annotate.viewport.desktop": "데스크톱",
  "annotate.tool.pen": "펜",
  "annotate.tool.highlight": "형광펜",
  "annotate.tool.arrow": "화살표",
  "annotate.tool.rect": "사각형",
  "annotate.tool.ellipse": "원",
  "annotate.tool.text": "텍스트",
  "annotate.tool.inspect": "살펴보기",
  "annotate.undo": "실행 취소",
  "annotate.redo": "다시 실행",
  "annotate.clear": "지우기",
  "annotate.color.label": "색",
  "annotate.text.label": "캡션",
  "annotate.text.placeholder": "글자를 입력한 뒤 그림을 누르세요",
  "annotate.draw.hint": "손가락으로 스크린샷 위에 그리세요.",
  "annotate.inspect.hint": "요소를 누르면 무엇인지 알려줍니다.",
  "annotate.inspect.probing": "페이지에 물어보는 중…",
  "annotate.card.tag": "태그",
  "annotate.card.component": "컴포넌트",
  "annotate.card.source": "소스",
  "annotate.card.text": "텍스트",
  "annotate.note.label": "메모",
  "annotate.note.placeholder": "어디가 잘못됐나요?",
  "annotate.attach": "메시지 초안에 추가",
  "annotate.error.tooLarge": "가장 작은 크기로도 이 collie의 업로드 한도를 넘습니다.",
  "annotate.markup.title": "그림 위에 그리기",
  "annotate.markup.done": "완료",
  "composer.attachment.draw": "먼저 그림 위에 그리기",
  "composer.attachment.keep": "그대로 두기",
