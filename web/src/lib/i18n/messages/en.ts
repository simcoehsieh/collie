...
export const en = {
  ...
  "settings.notify.panes.title": "Per pane",
  "settings.notify.panes.hint": "Override the switches above for one pane. A rule also matches the pane's name, so it survives a restart.",
  "settings.notify.panes.mode.default": "Default",
  "settings.notify.panes.mode.all": "All",
  "settings.notify.panes.mode.blocked": "Needs input",
  "settings.notify.panes.mode.mute": "Mute",
  "settings.notify.panes.snooze": "Snooze 1h",
  "settings.notify.panes.snoozed": "Snoozed until {time}",
  "settings.notify.panes.resume": "Resume",
  ...
  "agentCard.approve.changed": "Prompt changed",
  "agentCard.approve.failed": "Failed",
  ...
  "composer.status.recallFailed": "Couldn't interrupt the agent",
  ...
  "dirs.truncated": "Showing the first {count}",
  "newTab.title": "What does + open?",
  "newTab.hint": "Tapping opens it now and makes it what + does.",
  "newTab.shell": "Plain shell",
  ...
  // --- FORK: the file viewer, the preview panel, and the mirror's line chips ---
  "diff.openFile": "Open file",
  "diff.openFileAria": "Open {path}",
  "diff.chipFiles": "{count} files",
  "diff.chipAria": "What changed: {files} files, {additions} added, {deletions} removed",
  "file.title": "File",
  "file.subtitle": "{lines} lines · {bytes} bytes",
  "file.loading": "Reading the file…",
  "file.refresh": "Refresh",
  "file.copyPath": "Copy path",
  "file.copied": "Copied",
  "file.preview": "Preview",
  "file.more": "Show {count} more lines",
  "file.truncated": "Cut short — the file is larger than the phone will show.",
  "file.error.binary": "Not a text file.",
  "file.error.outside": "The pane's folder is outside what Collie may read.",
  "file.error.badPath": "Not a path in this work tree.",
  "file.error.notFound": "No such file — it may have been moved or deleted.",
  "file.error.failed": "Couldn't read the file.",
  "preview.title": "Preview",
  "preview.reload": "Reload",
  "preview.openExternally": "Open in browser",
  "preview.width.aria": "Preview width",
  "preview.width.fit": "Fit",
  "mirror.chip.open": "Open",
  "mirror.chip.openAria": "Open {url}",
  "mirror.chip.preview": "Preview",
  "mirror.chip.previewAria": "Open the local server at {url}",
  "mirror.chip.file": "File",
  "mirror.chip.fileAria": "Open {path}",
  ...
  "hotkeys.open": "Open the selected pane",
  "hotkeys.nth": "Open the nth pane",
  "hotkeys.overview": "Overview",
  "hotkeys.home": "Home",
  "hotkeys.settings": "Settings",
  "hotkeys.palette": "Agent commands (on a pane)",
  "hotkeys.composer": "Focus the message box",
  "hotkeys.escape": "Leave the message box / close",
  "hotkeys.help": "This sheet",
  "settings.lowPower.title": "Low power",
  "settings.lowPower.description": "Read a followed terminal every 3 seconds instead of every second. Notifications and the live feed are unaffected.",
  "settings.lowPower.saveData": "On because this phone asked for less data (Data Saver).",
  "settings.readAloud.title": "Read replies aloud",
  "settings.readAloud.description": "While hands-free is on, each new reply is spoken by the phone. Nothing leaves the device.",
  ...
  "notes.title.one": "{count} note",
  "notes.title.other": "{count} notes",
  "notes.empty": "Nothing noted yet. Hold a diff hunk, a transcript turn or a document to add one.",
  "notes.send.one": "Send {count} note",
  "notes.send.other": "Send {count} notes",
  "notes.clearSent": "Clear sent",
  "notes.clearAll": "Clear all",
  "notes.sentLabel": "sent",
  "notes.markSent": "Mark sent",
  "notes.save": "Save",
  "notes.delete": "Delete note",
  "notes.status.sent": "Notes sent",
  "notes.sheet.add": "Add a note",
  "notes.sheet.edit": "Edit the note",
  "notes.excerpt.none": "The document is framed sandboxed, so no selected text can be read — this note points at the whole document.",
  "notes.comment.label": "What should the agent do?",
  "notes.comment.placeholder": "This sits 4px too low on a phone…",
  "notes.intent.label": "Intent",
  "notes.intent.bug": "Bug",
  "notes.intent.change": "Change",
  "notes.intent.question": "Question",
  "notes.kind.diff": "diff",
  "notes.kind.transcript": "turn",
  "notes.kind.doc": "doc",
  "notes.kind.element": "element",
  "notes.kind.artifact": "Artifact",
  "notes.badge.aria": "Note {index}",
  "notes.badge.sentAria": "Note {index}, sent",
  "notes.add.aria": "Add a note here",
  "notes.add.short": "note",
  "notes.edit.aria": "Edit the note here",
  "notes.edit.short": "edit",
  "notes.chip.aria": "{count} notes — open the list",
  "notes.doc.button": "Note this document",
  "notes.composer.label": "Notes",
  "notes.composer.remove": "Remove note {index}",
  "notes.composer.ask.one": "Send {count} note with this message?",
  "notes.composer.ask.other": "Send {count} notes with this message?",
  "notes.composer.include": "Include",
  "notes.composer.skip": "Not now",
  "hotkeys.notes": "Open this pane's notes",
  // --- fork: chat mode (pane transcript, ACP tool kinds, pinned plan, away rollup, status line) ---
  "chat.view.label": "Pane view",
  ...
  "artifacts.chip.aria": "{count} artifacts — open the list",
  "artifacts.sheet.title": "Made by this pane",
  "artifacts.sheet.all": "All artifacts",
  "artifacts.empty.heading": "Nothing made yet",
  "artifacts.empty.body": "When an agent registers a file it made, it lands here, filed under the pane that made it.",
  "artifacts.empty.pane": "This pane has not registered anything yet.",
  "artifacts.empty.search": "Nothing matches.",
  "artifacts.failed": "Couldn't read the library.",
  "artifacts.search.placeholder": "Search artifacts",
  "artifacts.pinned": "Pinned",
  "artifacts.recent": "Recent",
  "artifacts.card.version": "v{version}",
  "artifacts.card.open": "Open {title}",
  "artifacts.kind.html": "page",
  "artifacts.kind.markdown": "markdown",
  "artifacts.kind.image": "image",
  "artifacts.kind.text": "text",
  "artifacts.kind.file": "file",
  "artifacts.viewer.back": "Back",
  "artifacts.viewer.from": "From {pane}",
  "artifacts.viewer.origin": "From {origin}",
  "artifacts.viewer.noPane": "Not filed under a pane",
  "artifacts.viewer.pin": "Pin",
  "artifacts.viewer.unpin": "Unpin",
  "artifacts.viewer.refresh": "Reload",
  "artifacts.viewer.openTab": "Open in a new tab",
  "artifacts.viewer.delete": "Delete",
  "artifacts.viewer.deleteConfirm": "Tap again to delete this version. The bytes leave the library.",
  "artifacts.viewer.versions": "Versions",
  "artifacts.viewer.attachment": "Kept as an attachment — open it in a new tab to save or share it.",
  "artifacts.viewer.loading": "Loading…",
  "artifacts.viewer.missing": "This artifact is gone.",
  "artifacts.viewer.note": "Leave a note",
  "artifacts.viewer.inKb": "Open in the knowledge base",
  "preview.save": "Keep",
  "preview.saved": "Kept",
  "preview.saveFailed": "Couldn't keep",
  "chat.transcript.empty": "No conversation to show for this pane yet.",
  "chat.transcript.showTerminal": "Show the terminal",
  "chat.transcript.liveInTerminal": "Still working — live output is in Terminal",
  "chat.away.title": "While you were away",
  "chat.away.dismiss": "Dismiss",
  "chat.away.turns": "{n} agent turns",
  "chat.away.userTurns": "{n} from you",
  "chat.away.diff": "{files} files +{added} −{removed}",
  "chat.away.question": "A question has been waiting {age}",
  "chat.away.toolKind.read": "reads",
  "chat.away.toolKind.edit": "edits",
  "chat.away.toolKind.delete": "deletions",
  "chat.away.toolKind.move": "moves",
  "chat.away.toolKind.search": "searches",
  "chat.away.toolKind.execute": "commands",
  "chat.away.toolKind.think": "thinking steps",
  "chat.away.toolKind.fetch": "fetches",
  "chat.away.toolKind.other": "other calls",
  "transcript.todo.title": "Plan",
  "transcript.todo.progress": "{done}/{total} done",
  ...
  "handoff.model.label": "Codex model",
  "handoff.effort.label": "Reasoning effort",
  "handoff.model.default": "Launcher default",
  "handoff.model.loading": "Loading models…",
  "handoff.model.unavailable": "Model choices are unavailable. The launcher default still works.",
  "handoff.model.hint": "Choices come from Codex on this machine. Effort options follow the selected model.",
  "annotate.intro": "Capture a website running on your Mac",
  "annotate.step.source": "Enter the website URL and choose a screen size.",
  "annotate.step.mark": "Take a screenshot, then draw or inspect an element.",
  "annotate.step.draft": "Add it to your draft, describe the change, then send.",
  "annotate.photo.hint": "Already have a screenshot on your phone? Use the paperclip in the message box to attach and mark it.",
  ...
  "annotate.url.label": "Page address",
  "annotate.url.placeholder": "http://localhost:5173/",
  "annotate.shoot": "Take a shot",
  "annotate.retake": "Retake",
  "annotate.shooting": "Taking the shot — the Mac's browser is loading the page…",
  "annotate.empty": "Give it a local address and take a shot.",
  "annotate.viewport.label": "Screen size",
  "annotate.viewport.phone": "Phone",
  "annotate.viewport.tablet": "Tablet",
  "annotate.viewport.desktop": "Desktop",
  "annotate.tool.pen": "Pen",
  "annotate.tool.highlight": "Highlighter",
  "annotate.tool.arrow": "Arrow",
  "annotate.tool.rect": "Box",
  "annotate.tool.ellipse": "Circle",
  "annotate.tool.text": "Text",
  "annotate.tool.inspect": "Inspect",
  "annotate.undo": "Undo",
  "annotate.redo": "Redo",
  "annotate.clear": "Clear",
  "annotate.color.label": "Colour",
  "annotate.text.label": "Caption",
  "annotate.text.placeholder": "Type a caption, then tap the picture",
  "annotate.draw.hint": "Draw on the shot with your finger.",
  "annotate.inspect.hint": "Tap an element to see what it is.",
  "annotate.inspect.probing": "Asking the page what that is…",
  "annotate.card.tag": "Tag",
  "annotate.card.component": "Component",
  "annotate.card.source": "Source",
  "annotate.card.text": "Text",
  "annotate.note.label": "Note",
  "annotate.note.placeholder": "What is wrong with it?",
  "annotate.attach": "Add to message draft",
  "annotate.error.tooLarge": "Even at the smallest size the picture is over this collie's upload limit.",
  "annotate.markup.title": "Draw on it",
  "annotate.markup.done": "Done",
  "composer.attachment.draw": "Draw on the picture first",
  "composer.attachment.keep": "Keep it as it is",
