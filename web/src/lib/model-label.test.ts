...
// trimmed, the effort after a tight interpunct; nothing when the pane carries neither.

describe("modelLabel", () => {
  it("joins the trimmed model id and the effort with a TIGHT interpunct — they are one reading, not two facts", () => {
