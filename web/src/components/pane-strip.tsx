  ...
  return (
    ...
    >
      ...
      {/* The number is part of the pill's own text, not a decoration beside it: a screen reader
          hearing two pills called "claude" is in exactly the trouble the eye is. FORK: the ink is the
          tonal-selected pair's, not `--primary`'s, because this pill's own `active` fill is tonal. */}
      {ordinal !== undefined && (
        <span
          className={cn(
            "font-mono text-[10px]",
