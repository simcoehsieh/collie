      ...
      >
        <div
          ...
          className={cn(
            ...
            // The padding is 1.9.0's compact row (32px); upstream draws no rule under it any more.
            "flex select-none items-start gap-1 overflow-x-auto pt-1.5 pb-1.5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden",
