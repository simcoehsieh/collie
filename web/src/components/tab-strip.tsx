      ...
      >
        <div
          ...
          className={cn(
            ...
            "flex select-none items-center gap-3 overflow-x-auto pb-3.5 -mb-3.5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden",
          ...
          {newTab.capable && (
            <button
              ...
              className={cn(
                ...
                "flex size-7 shrink-0 select-none [-webkit-touch-callout:none] items-center justify-center rounded-full border border-dashed border-border text-muted-foreground transition-colors hover:bg-accent active:scale-95 disabled:opacity-100",
              )}
            >
        ...
        {/* The pinned slot. `self-center`: whatever stands here is a control beside the tabs, not a
            ...
            "+" does. */}
        {trailing !== undefined && (
          <div className="flex shrink-0 items-center gap-1 self-center pl-1.5">{trailing}</div>
        )}
      </nav>
